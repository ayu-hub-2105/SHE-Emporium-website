...
export const CategoryView: React.FC<CategoryViewProps> = ({
  ...
  return (
    <div className="w-full bg-[#fcf9f8] min-h-screen text-left">
      ...
      <div className="relative w-full bg-[#1c1b1b] text-white overflow-hidden py-16 md:py-24 border-b border-[#eae7e7]">
        <div
        ...
        <div className="relative max-w-[1440px] mx-auto px-4 md:px-16 z-10">
          {/* Breadcrumbs */}
          <nav className="flex items-center gap-2 text-[11px] uppercase tracking-widest text-[#dac0c2] mb-6">
            <button
          ...
          <span className="inline-block px-3 py-1 bg-[#4e051a] text-white text-[9px] uppercase tracking-[0.24em] font-bold mb-4">
            Curated Atelier Collection
          </span>

          <h1 className="font-serif text-[36px] md:text-[54px] font-normal tracking-tight text-white leading-tight max-w-2xl">
            {meta.title}
          </h1>

          <p className="font-serif italic text-[16px] md:text-[18px] text-[#dac0c2] mt-2 max-w-xl">
            {meta.subtitle}
          </p>

          <p className="text-[13px] text-[#eae7e7] max-w-xl mt-3 leading-relaxed font-light">
            {meta.description}
          </p>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            <button
              ...
              className="bg-[#4e051a] hover:bg-[#6b1d2f] text-white px-6 py-3 text-[11px] uppercase tracking-[0.16em] font-semibold transition-all shadow-md flex items-center gap-2 cursor-pointer"
            >
              <span className="material-symbols-outlined text-[18px]">straighten</span>
              <span>Find My Precision Fit</span>
            </button>
            <div className="text-[12px] text-[#dac0c2] font-mono">
              {displayedProducts.length} Bespoke Patterns Found
            </div>
          </div>
        </div>
      </div>
